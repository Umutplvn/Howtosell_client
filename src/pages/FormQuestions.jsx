      ...
      <TransitionGroup>
        <CSSTransition key={currentQuestion} timeout={300} classNames="fade">
          ...
          >
            ...
            {currentQuestion === 0 && (
              <>
<Typography sx={{marginBottom:"1rem", fontSize:{xs:"0.66rem", sm:"0.8rem", md:"0.9rem"}, textAlign:"left",  color: "#0445AF",   width: { xs: "300px", sm: "500px" }}}>
  {'Let’s see if this is a good fit. Takes < 2 minutes to complete.'}
</Typography>
                <Typography
                  sx={{
                    mb: 2,
            ...
            {currentQuestion === 9 && (
              <>
                ...
                >
                  (E.g. close more deals, fix team process, reduce ghosting)
                </Typography>
            ...
            {currentQuestion === 10 && (
              <>
                ...
                >
                  (E.g. team not following structure, leads going cold, low
                  close rates)
                </Typography>
                <TextField
                  autoFocus
            ...
            {currentQuestion === 12 && (
              <>
                ...
                <RadioGroup
                  ...
                  onKeyDown={handleKeyDown}
                >
                  {["€5,000–€10,000", "€10,000–€20,000", "€20,000+"].map(
                    (value) => (
                      <Sheet
                        key={value}
                        sx={{ p: 2, borderRadius: "sm", boxShadow: "sm" }}
